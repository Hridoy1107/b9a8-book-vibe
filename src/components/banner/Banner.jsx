...
const Banner = () => {
    const link = <>
        <NavLink to="/lbs" className=" absolute left-0 rounded-xl btn w-[180px] h-[64px] hover:bg-[#23BE0A] bg-[#23BE0A] text-white text-2xl border-none">View The List</NavLink>
    </>
    return (
    <>
