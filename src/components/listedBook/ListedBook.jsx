...
const ListedBook = ({ book }) => {
    ...
    return (
        <>
            <div className="w-[1170px] rounded-xl h-[240px] mt-9 bg-slate-300">
                <div className="flex ml-16">
                    ...
                    <div>
                        ...
                        <div className="flex">
                            <div className="flex w-[310px] gap-1 ml-4"> <div className="mt-1 "><BsPerson /></div> <h1>Publisher: {publisher}</h1></div>
                        ...
                        <div className="mt-2 gap-5">
                            <div className="badge badge-secondary h-[48px] w-[210px] mr-4 text-black font-semibold">Category: {category}</div>
                            <div className="badge badge-primary h-[48px] w-[170px] mr-4 text-black font-semibold">Rating: {rating}</div>
